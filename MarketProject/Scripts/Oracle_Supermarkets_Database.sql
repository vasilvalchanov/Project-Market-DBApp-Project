...
create user supermarkets IDENTIFIED BY supermarkets
default tablespace supermarkets_tabspace
temporary tablespace supermarkets_tabspace_temp;

--Grant privileges
grant connect, resource to supermarkets

--Assign SYSTEM privileges to new user in Oracle

GRANT create session TO supermarkets;
GRANT create table TO supermarkets;
GRANT create view TO supermarkets;
GRANT create any trigger TO supermarkets;
GRANT create any procedure TO supermarkets;
GRANT create sequence TO supermarkets;
GRANT create synonym TO supermarkets;
GRANT unlimited tablespace TO supermarkets;


--Change the default db schema
ALTER SESSION SET CURRENT_SCHEMA = supermarkets;
